      ...
      {selectedYear && (
        <div className="flex-1 border border-[var(--hrs-line)] rounded-lg bg-[var(--hrs-surface)] shadow-[0_1px_2px_rgba(16,24,40,0.05)] overflow-hidden flex flex-col">
          <div className="grid grid-cols-12 bg-[var(--hrs-bg)] text-[var(--hrs-slate)] border-b border-[var(--hrs-line)] font-semibold text-[12px] uppercase tracking-[0.04em] p-4 sticky top-0">
            ...
            <div className="col-span-1"><SortHeader label="진행률" colKey="progress" sortKey={sortKey} sortDir={sortDir} onSort={handleSort} align="center" /></div>
              ...
              sortedEvaluatees.map(ev => {
                ...
                return (
                  <div key={ev.evaluateeId} className="grid grid-cols-12 p-4 border-b border-[var(--hrs-line-soft)] items-center hover:bg-[var(--hrs-bg)] cursor-default group">
                    ...
                    <div className="col-span-1 font-sans text-xs text-center text-[var(--hrs-slate)]">{fmtService(ev.evaluateeId)}</div>
