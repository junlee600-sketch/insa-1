  ...
  return (
    <div className="space-y-6">
      <header className="flex justify-between items-end mb-12 border-b border-[var(--hrs-line)] pb-6">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight">평가 항목 관리</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="flex-1 border border-[var(--hrs-line)] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto  text-sm">
              {items.length === 0 ? (
                <div className="p-8 text-center text-[var(--hrs-slate)] font-sans">선택한 연도 및 그룹에 등록된 평가 항목이 없습니다.</div>
              ) : (
