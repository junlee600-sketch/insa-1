    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-12">
        ...
        <section className="space-y-6">
          <h3 className="text-2xl tracking-tighter border-b border-[var(--hrs-line)] pb-2">평가 연도 관리</h3>
          ...
          <div className="border border-[var(--hrs-line)] flex flex-col">
            {years.map(y => (
              <div key={y.id} className="flex justify-between items-center p-4 border-b border-[var(--hrs-line-soft)] hover:bg-[var(--hrs-bg)] transition-colors">
        ...
        {/* Groups Management */}
        <section className="space-y-6">
          <h3 className="text-2xl tracking-tighter border-b border-[var(--hrs-line)] pb-2">평가 그룹 관리</h3>
          <div className="flex gap-4">
            <Input 
              placeholder="새 그룹 이름" 
              value={newGroupName} 
          ...
          <div className="border border-[var(--hrs-line)] flex flex-col">
            {groups.map(g => (
              <div key={g.id} className="flex justify-between items-center p-4 border-b border-[var(--hrs-line-soft)] hover:bg-[var(--hrs-bg)] transition-colors">
