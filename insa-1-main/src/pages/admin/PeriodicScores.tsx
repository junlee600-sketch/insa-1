    ...
    <div className="space-y-6">
      <header className="flex justify-between items-end mb-8 border-b border-[var(--hrs-line)] pb-6">
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--hrs-slate)] tracking-normal text-[12px]">연도별 근태·업무일지 점수를 일괄 부여합니다 (0~100)</p>
        </div>
        <div className="flex gap-3 items-center">
          <button onClick={downloadTemplate} className="px-5 py-2 border border-[var(--hrs-line)] text-[12px] tracking-normal hover:bg-[var(--hrs-accent)] hover:text-white transition-colors">
            엑셀 양식/현황 다운로드
          </button>
      ...
      <div className="flex gap-4 items-center">
        ...
        <Input
          ...
          className="max-w-xs border border-[var(--hrs-line)] rounded-md bg-white px-3 focus-visible:ring-0 focus-visible:border-[var(--hrs-line)]"
        />
      ...
      {!selectedYear ? (
        ...
        <div className="border border-[var(--hrs-line)] rounded-lg bg-[var(--hrs-surface)] shadow-[0_1px_2px_rgba(16,24,40,0.05)] overflow-hidden flex flex-col">
